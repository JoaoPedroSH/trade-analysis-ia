...
const items = ref([
    { label: 'Ver histórico', icon: 'pi pi-fw pi-history' },
    { label: 'Limpar', icon: 'pi pi-fw pi-trash' },
]);
</script>
...
<template>
    <div class="card">
        <div class="flex items-center justify-between mb-6">
            <div class="font-semibold text-xl">Últimos Sinais</div>
            <div>
        ...
        <span class="block text-muted-color font-medium mb-4">27/03/2025</span>
        <ul class="p-0 mx-0 mt-0 mb-6 list-none">
            ...
            <li class="flex items-center py-2">
                <div class="w-12 h-12 flex items-center justify-center bg-red-100 dark:bg-red-400/10 rounded-full mr-4 shrink-0">
                    <i class="pi pi-arrow-down !text-xl text-red-500"></i>
                </div>
